...
export interface ApplicationUser
  extends Model<typeof metadata.ApplicationUser> {
  id: string | null;
  name: string | null;
  email: string | null;
...
export interface AssignmentSkill
  extends Model<typeof metadata.AssignmentSkill> {
...
export interface OrganizationUser
  extends Model<typeof metadata.OrganizationUser> {
  organizationUserId: string | null;
  organizationId: string | null;
  organization: Organization | null;
...
export namespace Project {
  export namespace DataSources {
    export class ProjectWithAssignments
      implements
        DataSource<typeof metadata.Project.dataSources.projectWithAssignments>
    {
