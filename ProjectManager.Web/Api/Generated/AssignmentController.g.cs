...
namespace ProjectManager.Web.Api
{
        ...
        : BaseApiController<ProjectManager.Data.Models.Assignment, AssignmentDtoGen, ProjectManager.Data.AppDbContext>
    {
        ...
        [Authorize]
        public virtual async Task<ItemResult<System.Collections.Generic.ICollection<UserDtoGen>>> GetUsersWithSkills([FromServices] IDataSourceFactory dataSourceFactory, int id)
        {
            ...
            {
                return new ItemResult<System.Collections.Generic.ICollection<UserDtoGen>>(itemResult);
            }
            ...
            var _result = new ItemResult<System.Collections.Generic.ICollection<UserDtoGen>>();
            _result.Object = _methodResult?.ToList().Select(o => Mapper.MapToDto<ProjectManager.Data.Models.User, UserDtoGen>(o, _mappingContext, includeTree)).ToList();
            return _result;
        }
    }
}
